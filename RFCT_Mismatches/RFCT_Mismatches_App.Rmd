...
rsconnect::deployApp("RFCT_Mismatches")
...
MetaData_Blurb <- "This Station Data "

Map_blurb <- "This map shows... "
      ...
      mainPanel(
        tabsetPanel( id = 'Tabs',
                     ...
                     tabPanel('Phenology of Risk', 
                              fluidRow(textOutput('POR_blurb'), hr(), plotOutput("PORplot", width = "100%", height = "90vh"))),
                     ...
                     tabPanel('Map Meta Data', 
                              fluidRow(dataTableOutput("Station_data")))
